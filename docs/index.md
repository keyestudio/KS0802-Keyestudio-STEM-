...
1. Align the expansion board with the holes in the basswood board, then fix it with screws.
   ...
   <p style="color:red;">Attention: When installing the expansion board, you should refer to the corresponding holes on the wooden board corresponding to the solder joints under the expansion board!</p>
